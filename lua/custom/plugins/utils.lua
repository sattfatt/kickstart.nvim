  ...
  },
  {
    ...
    keys = {
      ...
      },
      {
        '<Leader>li',
        function()
          vim.cmd 'FloatermNew --title=jira --width=1.0 --height=1.0 jira issue list -a$(jira me) -Rx "done" -s "In Progress" -s "Selected For Development" -s "Engineering Backlog"'
        end,
      ...
      },
      {
        '<Leader>le',
        function()
          vim.cmd 'FloatermNew --title=epics --width=1.0 --height=1.0 jira epic list --table -a satyam.patel@rockbot.com -s "In Progress" -s "Selected For Development" -s "Engineering Backlog"'
        end,
